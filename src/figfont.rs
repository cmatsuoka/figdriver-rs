...
pub struct FIGfont {
    /// The font standard version (currently 'a').
    version       : char,
    ...
    /// The number of code-tagged FIGcharacters in this FIGfont.
    count         : u32,

    /// Actual FIGcharacter definitions for this font.
    chars         : Arc<HashMap<i32, FIGchar>>,
}
